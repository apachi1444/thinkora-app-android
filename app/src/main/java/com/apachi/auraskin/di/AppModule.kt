...
import com.apachi.auraskin.data.local.QuoteDatabase
...
//    @Provides
//    @Singleton
    fun provideHabitDao(db: QuoteDatabase): com.apachi.auraskin.data.local.dao.HabitDao {
        return db.habitDao
    }

//    @Provides
//    @Singleton
    fun provideNotificationDao(db: QuoteDatabase): com.apachi.auraskin.data.local.dao.NotificationDao {
