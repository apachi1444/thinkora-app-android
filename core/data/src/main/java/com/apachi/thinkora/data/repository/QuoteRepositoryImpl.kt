...
import com.apachi.thinkora.data.preferences.dataStore
...
class QuoteRepositoryImpl @Inject constructor(
    ...
    private val analyticsManager: com.apachi.thinkora.data.analytics.AnalyticsManager
) : QuoteRepository {
...
fun QuoteEntity.toDomain(isRead: Boolean): Quote {
    return Quote(
        id = id,
        content = content,
        author = author,
